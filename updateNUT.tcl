...
pack [ttk::label .nut.qn.label -text "NUT has ended."]
...
trace add variable ::PROCNTopt write [list opt_change PROCNT]
trace add variable ::FATopt write [list opt_change FAT]
trace add variable ::CHOCDFopt write [list opt_change CHOCDF]
trace add variable ::ENERC_KCALopt write [list opt_change ENERC_KCAL]
trace add variable ::FIBTGopt write [list opt_change FIBTG]
trace add variable ::CAopt write [list opt_change CA]
trace add variable ::FEopt write [list opt_change FE]
trace add variable ::MGopt write [list opt_change MG]
trace add variable ::Popt write [list opt_change P]
trace add variable ::Kopt write [list opt_change K]
trace add variable ::NAopt write [list opt_change NA]
trace add variable ::ZNopt write [list opt_change ZN]
trace add variable ::CUopt write [list opt_change CU]
trace add variable ::MNopt write [list opt_change MN]
trace add variable ::SEopt write [list opt_change SE]
trace add variable ::VITA_IUopt write [list opt_change VITA_IU]
trace add variable ::VITDopt write [list opt_change VITD]
trace add variable ::VITCopt write [list opt_change VITC]
trace add variable ::THIAopt write [list opt_change THIA]
trace add variable ::RIBFopt write [list opt_change RIBF]
trace add variable ::NIAopt write [list opt_change NIA]
trace add variable ::PANTACopt write [list opt_change PANTAC]
trace add variable ::VITB6Aopt write [list opt_change VITB6A]
trace add variable ::FOLopt write [list opt_change FOL]
trace add variable ::VITB12opt write [list opt_change VITB12]
trace add variable ::VITK1opt write [list opt_change VITK1]
trace add variable ::CHOLEopt write [list opt_change CHOLE]
trace add variable ::FASATopt write [list opt_change FASAT]
trace add variable ::FAMSopt write [list opt_change FAMS]
trace add variable ::FAPUopt write [list opt_change FAPU]
trace add variable ::CHO_NONFIBopt write [list opt_change CHO_NONFIB]
trace add variable ::LAopt write [list opt_change LA]
trace add variable ::AAopt write [list opt_change AA]
trace add variable ::ALAopt write [list opt_change ALA]
trace add variable ::EPAopt write [list opt_change EPA]
trace add variable ::DHAopt write [list opt_change DHA]
trace add variable ::OMEGA6opt write [list opt_change OMEGA6]
trace add variable ::OMEGA3opt write [list opt_change OMEGA3]
trace add variable ::VITEopt write [list opt_change VITE]
...
::trace add variable ::PROCNTam write ::PROCNTdv_change
::trace add variable ::PROCNTrm write ::PROCNTnew_rm
::trace add variable ::PROCNTvf write ::PROCNTnew_vf
::trace add variable ::PROCNTdv write ::PROCNTnew_dv
...
::trace add variable ::FATam write ::FATdv_change
::trace add variable ::FATrm write ::FATnew_rm
::trace add variable ::FATvf write ::FATnew_vf
::trace add variable ::FATdv write ::FATnew_dv
...
::trace add variable ::CHOCDFam write ::CHOCDFdv_change
::trace add variable ::CHOCDFrm write ::CHOCDFnew_rm
::trace add variable ::CHOCDFvf write ::CHOCDFnew_vf
::trace add variable ::CHOCDFdv write ::CHOCDFnew_dv
...
::trace add variable ::ENERC_KCALam write ::ENERC_KCALdv_change
::trace add variable ::ENERC_KCALrm write ::ENERC_KCALnew_rm
::trace add variable ::ENERC_KCALvf write ::ENERC_KCALnew_vf
::trace add variable ::ENERC_KCALdv write ::ENERC_KCALnew_dv
...
::trace add variable ::FIBTGam write ::FIBTGdv_change
::trace add variable ::FIBTGrm write ::FIBTGnew_rm
::trace add variable ::FIBTGvf write ::FIBTGnew_vf
::trace add variable ::FIBTGdv write ::FIBTGnew_dv
...
::trace add variable ::CAam write ::CAdv_change
::trace add variable ::CArm write ::CAnew_rm
::trace add variable ::CAvf write ::CAnew_vf
::trace add variable ::CAdv write ::CAnew_dv
...
::trace add variable ::FEam write ::FEdv_change
::trace add variable ::FErm write ::FEnew_rm
::trace add variable ::FEvf write ::FEnew_vf
::trace add variable ::FEdv write ::FEnew_dv
...
::trace add variable ::MGam write ::MGdv_change
::trace add variable ::MGrm write ::MGnew_rm
::trace add variable ::MGvf write ::MGnew_vf
::trace add variable ::MGdv write ::MGnew_dv
...
::trace add variable ::Pam write ::Pdv_change
::trace add variable ::Prm write ::Pnew_rm
::trace add variable ::Pvf write ::Pnew_vf
::trace add variable ::Pdv write ::Pnew_dv
...
::trace add variable ::Kam write ::Kdv_change
::trace add variable ::Krm write ::Knew_rm
::trace add variable ::Kvf write ::Knew_vf
::trace add variable ::Kdv write ::Knew_dv
...
::trace add variable ::NAam write ::NAdv_change
::trace add variable ::NArm write ::NAnew_rm
::trace add variable ::NAvf write ::NAnew_vf
::trace add variable ::NAdv write ::NAnew_dv
...
::trace add variable ::ZNam write ::ZNdv_change
::trace add variable ::ZNrm write ::ZNnew_rm
::trace add variable ::ZNvf write ::ZNnew_vf
::trace add variable ::ZNdv write ::ZNnew_dv
...
::trace add variable ::CUam write ::CUdv_change
::trace add variable ::CUrm write ::CUnew_rm
::trace add variable ::CUvf write ::CUnew_vf
::trace add variable ::CUdv write ::CUnew_dv
...
::trace add variable ::MNam write ::MNdv_change
::trace add variable ::MNrm write ::MNnew_rm
::trace add variable ::MNvf write ::MNnew_vf
::trace add variable ::MNdv write ::MNnew_dv
...
::trace add variable ::SEam write ::SEdv_change
::trace add variable ::SErm write ::SEnew_rm
::trace add variable ::SEvf write ::SEnew_vf
::trace add variable ::SEdv write ::SEnew_dv
...
::trace add variable ::VITA_IUam write ::VITA_IUdv_change
::trace add variable ::VITA_IUrm write ::VITA_IUnew_rm
::trace add variable ::VITA_IUvf write ::VITA_IUnew_vf
::trace add variable ::VITA_IUdv write ::VITA_IUnew_dv
...
::trace add variable ::VITDam write ::VITDdv_change
::trace add variable ::VITDrm write ::VITDnew_rm
::trace add variable ::VITDvf write ::VITDnew_vf
::trace add variable ::VITDdv write ::VITDnew_dv
...
::trace add variable ::VITCam write ::VITCdv_change
::trace add variable ::VITCrm write ::VITCnew_rm
::trace add variable ::VITCvf write ::VITCnew_vf
::trace add variable ::VITCdv write ::VITCnew_dv
...
::trace add variable ::THIAam write ::THIAdv_change
::trace add variable ::THIArm write ::THIAnew_rm
::trace add variable ::THIAvf write ::THIAnew_vf
::trace add variable ::THIAdv write ::THIAnew_dv
...
::trace add variable ::RIBFam write ::RIBFdv_change
::trace add variable ::RIBFrm write ::RIBFnew_rm
::trace add variable ::RIBFvf write ::RIBFnew_vf
::trace add variable ::RIBFdv write ::RIBFnew_dv
...
::trace add variable ::NIAam write ::NIAdv_change
::trace add variable ::NIArm write ::NIAnew_rm
::trace add variable ::NIAvf write ::NIAnew_vf
::trace add variable ::NIAdv write ::NIAnew_dv
...
::trace add variable ::PANTACam write ::PANTACdv_change
::trace add variable ::PANTACrm write ::PANTACnew_rm
::trace add variable ::PANTACvf write ::PANTACnew_vf
::trace add variable ::PANTACdv write ::PANTACnew_dv
...
::trace add variable ::VITB6Aam write ::VITB6Adv_change
::trace add variable ::VITB6Arm write ::VITB6Anew_rm
::trace add variable ::VITB6Avf write ::VITB6Anew_vf
::trace add variable ::VITB6Adv write ::VITB6Anew_dv
...
::trace add variable ::FOLam write ::FOLdv_change
::trace add variable ::FOLrm write ::FOLnew_rm
::trace add variable ::FOLvf write ::FOLnew_vf
::trace add variable ::FOLdv write ::FOLnew_dv
...
::trace add variable ::VITB12am write ::VITB12dv_change
::trace add variable ::VITB12rm write ::VITB12new_rm
::trace add variable ::VITB12vf write ::VITB12new_vf
::trace add variable ::VITB12dv write ::VITB12new_dv
...
::trace add variable ::VITK1am write ::VITK1dv_change
::trace add variable ::VITK1rm write ::VITK1new_rm
::trace add variable ::VITK1vf write ::VITK1new_vf
::trace add variable ::VITK1dv write ::VITK1new_dv
...
::trace add variable ::CHOLEam write ::CHOLEdv_change
::trace add variable ::CHOLErm write ::CHOLEnew_rm
::trace add variable ::CHOLEvf write ::CHOLEnew_vf
::trace add variable ::CHOLEdv write ::CHOLEnew_dv
...
::trace add variable ::FASATam write ::FASATdv_change
::trace add variable ::FASATrm write ::FASATnew_rm
::trace add variable ::FASATvf write ::FASATnew_vf
::trace add variable ::FASATdv write ::FASATnew_dv
...
::trace add variable ::FAMSam write ::FAMSdv_change
::trace add variable ::FAMSrm write ::FAMSnew_rm
::trace add variable ::FAMSvf write ::FAMSnew_vf
::trace add variable ::FAMSdv write ::FAMSnew_dv
...
::trace add variable ::FAPUam write ::FAPUdv_change
::trace add variable ::FAPUrm write ::FAPUnew_rm
::trace add variable ::FAPUvf write ::FAPUnew_vf
::trace add variable ::FAPUdv write ::FAPUnew_dv
...
::trace add variable ::CHO_NONFIBam write ::CHO_NONFIBdv_change
::trace add variable ::CHO_NONFIBrm write ::CHO_NONFIBnew_rm
::trace add variable ::CHO_NONFIBvf write ::CHO_NONFIBnew_vf
::trace add variable ::CHO_NONFIBdv write ::CHO_NONFIBnew_dv
...
::trace add variable ::LAam write ::LAdv_change
::trace add variable ::LArm write ::LAnew_rm
::trace add variable ::LAvf write ::LAnew_vf
::trace add variable ::LAdv write ::LAnew_dv
...
::trace add variable ::AAam write ::AAdv_change
::trace add variable ::AArm write ::AAnew_rm
::trace add variable ::AAvf write ::AAnew_vf
::trace add variable ::AAdv write ::AAnew_dv
...
::trace add variable ::ALAam write ::ALAdv_change
::trace add variable ::ALArm write ::ALAnew_rm
::trace add variable ::ALAvf write ::ALAnew_vf
::trace add variable ::ALAdv write ::ALAnew_dv
...
::trace add variable ::EPAam write ::EPAdv_change
::trace add variable ::EPArm write ::EPAnew_rm
::trace add variable ::EPAvf write ::EPAnew_vf
::trace add variable ::EPAdv write ::EPAnew_dv
...
::trace add variable ::DHAam write ::DHAdv_change
::trace add variable ::DHArm write ::DHAnew_rm
::trace add variable ::DHAvf write ::DHAnew_vf
::trace add variable ::DHAdv write ::DHAnew_dv
...
::trace add variable ::OMEGA6am write ::OMEGA6dv_change
::trace add variable ::OMEGA6rm write ::OMEGA6new_rm
::trace add variable ::OMEGA6vf write ::OMEGA6new_vf
::trace add variable ::OMEGA6dv write ::OMEGA6new_dv
...
::trace add variable ::OMEGA3am write ::OMEGA3dv_change
::trace add variable ::OMEGA3rm write ::OMEGA3new_rm
::trace add variable ::OMEGA3vf write ::OMEGA3new_vf
::trace add variable ::OMEGA3dv write ::OMEGA3new_dv
...
::trace add variable ::VITEam write ::VITEdv_change
::trace add variable ::VITErm write ::VITEnew_rm
::trace add variable ::VITEvf write ::VITEnew_vf
::trace add variable ::VITEdv write ::VITEnew_dv
...
# grid remove .nut.po.pane.wlogframe.accept
...
# grid .nut.po.pane.wlogframe.accept
